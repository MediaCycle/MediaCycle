/**
 * @brief Driver using libusb to handle USB communications with the Sony PS3 EYE Camera
 * @description from https://github.com/inspirit/PS3EYEDriver/tree/master/src
 * @author Eugene Zatepyakin
 * @date 6/04/2013
 * @copyright 2013 Eugene Zatepyakin. All rights reserved.
 */
...
PS3EYECam::PS3EYECam(libusb_device *device)
{
    ...
    is_streaming = false;//CF wasn't initialized!
}
