...
class ImageExtractor {
 public:
    ...
    /**
     * \returns the names of succesfully extracted images
     */
    inline std::vector<std::string> GetExtractedImageNames() const;
 ...
 private:
    ...
    std::vector<std::string> m_nFiles;
...
inline std::vector<std::string> ImageExtractor::GetExtractedImageNames() const
{
    return m_nFiles;
}
