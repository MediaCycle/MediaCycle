...
private:
  ...
  bool findInitialBracket (CostFunction & costFunction,
                           Matrix & pointA, const Matrix & negativeGradient,
                           double initialStepSize);

public:
  GoldenSectionSearch ();

  double operator () (CostFunction & costFunction, Matrix & pointA,
                      const Matrix & negativeGradient, double initialStepSize,
                      double &finalCost);
};
