...
public:
    ACSettingsDialogQt(ACMultiMediaCycleQt* _mc);
    virtual ~ACSettingsDialogQt();
    void setMediaCycleMainWindow(ACMultiMediaCycleQt* _mc);
...
private:
    ACMultiMediaCycleQt* multi_media_cycle;
