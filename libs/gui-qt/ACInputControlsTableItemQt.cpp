/*
 *  ACInputControlsTableItemQt.cpp
 *  MediaCycle
 *
...
ACInputControlsTableItemQt::ACInputControlsTableItemQt(const QString& sText)
: QTableWidgetItem(sText)
{
    setFlags(flags() & ~Qt::ItemIsEditable);
}

ACInputControlsTableItemQt::ACInputControlsTableItemQt(const QKeySequence& shortcut)
