...
// constructor : 
// parent is typically ACMultiMediaCycleQt->parent
ACSettingsDialogQt::ACSettingsDialogQt(ACMultiMediaCycleQt* _mc) : QMainWindow() {
    setupUi(this);
...
void ACSettingsDialogQt::setMediaCycleMainWindow(ACMultiMediaCycleQt* _mcw) {
