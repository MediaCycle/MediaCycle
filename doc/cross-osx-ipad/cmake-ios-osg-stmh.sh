...
if [ "$TARGET_SDK" = "device" ]; then
	...
	FLAGS="-miphoneos-version-min=${IPHONEOS_VERSION_MIN} -mno-thumb -arch i386 -pipe -no-cpp-precomp -fobjc-abi-version=2 -fobjc-legacy-dispatch"
	ARCH="i386"
