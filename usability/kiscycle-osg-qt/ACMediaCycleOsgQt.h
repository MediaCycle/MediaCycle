...
#ifndef HEADER_ACMediaCycleOsgQt
#define HEADER_ACMediaCycleOsgQt
...
#include "ui_ACMediaCycleOsgQt.h"
...
class ACMediaCycleOsgQt : public QMainWindow, public ACEventListener {
    Q_OBJECT
...
public:
    ACMediaCycleOsgQt(QWidget *parent = 0);
    ~ACMediaCycleOsgQt();
