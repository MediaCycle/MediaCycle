...
#ifndef __ACOSG_TRACK_CONTROLS_RENDERER_H__
#define __ACOSG_TRACK_CONTROLS_RENDERER_H__
...
public:
	...
	MatrixTransform* getControls() { return track_node; };
