...
ACBrowserControlsClustersNeighborsDockWidgetQt::ACBrowserControlsClustersNeighborsDockWidgetQt(QWidget *parent)
	: ACAbstractDockWidgetQt(parent, MEDIA_TYPE_ALL,"ACBrowserControlsClustersNeighborsDockWidgetQtb")
{
...
void ACBrowserControlsClustersNeighborsDockWidgetQt::modifyListItem(QListWidgetItem *item) {
	// XS check
