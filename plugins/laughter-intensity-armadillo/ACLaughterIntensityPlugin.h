...
#ifndef _ACLAUGHTERINTENSITYPLUGIN_H
#define	_ACLAUGHTERINTENSITYPLUGIN_H
...
class ACLaughterIntensityPlugin : public ACTimedFeaturesPlugin {
public:
    ACLaughterIntensityPlugin();
    ~ACLaughterIntensityPlugin();
