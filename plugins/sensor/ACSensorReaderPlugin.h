...
#ifndef ACSensorReaderPlugin_H
#define	ACSensorReaderPlugin_H

class ACSensorReaderPlugin : public ACMediaReaderPlugin
{
public:
    ACSensorReaderPlugin();
    ~ACSensorReaderPlugin();
