...
#ifndef ACVideoOsgReaderPlugin_H
#define	ACVideoOsgReaderPlugin_H
...
// we assume OSG can list the supported video file extensions

class ACVideoOsgReaderPlugin : public ACMediaReaderPlugin
{
public:
    ACVideoOsgReaderPlugin();
    ~ACVideoOsgReaderPlugin();
