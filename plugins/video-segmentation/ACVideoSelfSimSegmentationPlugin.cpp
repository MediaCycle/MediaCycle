/*
 *  ACVideoSelfSimSegmentationPlugin.cpp
 *  MediaCycle
 *
...
#include "ACVideoSelfSimSegmentationPlugin.h"

#include <vector>
#include <string>

ACVideoSelfSimSegmentationPlugin::ACVideoSelfSimSegmentationPlugin() : ACSegmentationPlugin(),ACSelfSimSegmentation(){
    this->mMediaType = MEDIA_TYPE_VIDEO;
    this->mName = "Video Self-Similarity Segmentation";
    this->mDescription = "Self-Similarity Segmentation plugin for video";
    this->mId = "";
...
ACVideoSelfSimSegmentationPlugin::~ACVideoSelfSimSegmentationPlugin() {
}
...
std::vector<ACMedia*> ACVideoSelfSimSegmentationPlugin::segment(ACMediaTimedFeature* _MTF, ACMedia* _theMedia){
    ...
    cout << "ACVideoSelfSimSegmentationPlugin::segment: user-defined parameters for segmentation: " <<  this->KernelType << " / " << this->DistanceType << " / " << this->Wmin << " / " << this->SelfSimThresh << " / " << this->L << endl; //CPL
