...
void setDefaultOptions(Pool& pool) {
  ...
  pool.set("sfx.frameSize", 2048); // CF same as lowlevel, necessary for ACAudioEssentiaMtfOutput to recognize temporal features
  pool.set("sfx.hopSize", 1024); // CF same as lowlevel, necessary for ACAudioEssentiaMtfOutput to recognize temporal features
...
void mergeOptionsAndResults(Pool& results, const Pool& options) {
  ...
  results.set("configuration.sfx.frameSize",    options.value<Real>("sfx.frameSize")); // CF same as lowlevel, necessary for ACAudioEssentiaMtfOutput to recognize temporal features
  results.set("configuration.sfx.hopSize",      options.value<Real>("sfx.hopSize")); // CF same as lowlevel, necessary for ACAudioEssentiaMtfOutput to recognize temporal features
