...
void compute(const string& audioFilename, const string& outputFilename,
 ...
 if (neqloud) {
   ...
   //CF outputToFile(stats, neqOutputFilename, options);
   outputToFile(neqloudPool, neqOutputFilename, options);
 ...
 if (eqloud) {
   ...
   //CF outputToFile(stats, outputFilename, options);
   outputToFile(eqloudPool, outputFilename, options);
