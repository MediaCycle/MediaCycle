...
#ifndef _ACFilterPlugUnispring_
#define _ACFilterPlugUnispring_

class ACFilterPlugUnispring : public QObject, public ACPluginQt, virtual public ACFilteringPlugin {
    Q_OBJECT
    Q_INTERFACES(ACPluginQt)
public:
    ACFilterPlugUnispring();
    virtual ~ACFilterPlugUnispring();
    virtual void filter();
private:
