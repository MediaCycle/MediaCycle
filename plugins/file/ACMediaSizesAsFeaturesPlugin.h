...
#ifndef _ACMediaSizesAsFeaturesPlugin_H
#define	_ACMediaSizesAsFeaturesPlugin_H

#include <MediaCycle.h>
#include<iostream>

class ACMediaSizesAsFeaturesPlugin : public ACFeaturesPlugin {
public:
    ACMediaSizesAsFeaturesPlugin();
    ~ACMediaSizesAsFeaturesPlugin();
...
#endif //_ACMediaSizesAsFeaturesPlugin_H
