...
ACVisPlugin_s_t_Sne::ACVisPlugin_s_t_Sne() : ACArmaVisPlugin(){
    ...
    this->mId = "";
    perplexity=20;
    this->addNumberParameter("perplexity",perplexity,5,100,10,"value of desired perplexity",boost::bind(&ACVisPlugin_s_t_Sne::perplexityValueChanged,this));
    slope=1.5;
    this->addNumberParameter("slope",slope,1,5,0.1,"value of desired interclass slope",boost::bind(&ACVisPlugin_s_t_Sne::slopeValueChanged,this));
    itMax=500;
    ...
    this->addStringParameter("Initialize","No",initializeValue,"Must we catch the current positions to initialize the t-Sne algorithm",boost::bind(&ACVisPlugin_s_t_Sne::initValueChanged,this));
    initFlag=false;
...
void  ACVisPlugin_s_t_Sne::dimensionReduction(mat &posDisp_m,arma::mat desc_m,arma::umat tag){
    st_Sne st_Sne_algo;
    st_Sne_algo.setPerplexity(perplexity);
