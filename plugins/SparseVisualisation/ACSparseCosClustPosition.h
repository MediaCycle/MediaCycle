...
#ifndef _ACSparseCosClustPosition_H
#define _ACSparseCosClustPosition_H
...
class ACSparseCosClustPosition : public ACClusterPositionsPlugin {
public:
...
#endif	/* _ACSparseCosClustPosition_H */
