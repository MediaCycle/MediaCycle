...
#ifndef AC3DModelOsgRendererPlugin_H
#define	AC3DModelOsgRendererPlugin_H

#include "ACOsgRendererPlugin.h"

class AC3DModelOsgRendererPlugin : public ACOsgRendererPlugin
{
public:
    AC3DModelOsgRendererPlugin();
    ~AC3DModelOsgRendererPlugin();
