...
#ifndef ACSensorOsgRendererPlugin_H
#define	ACSensorOsgRendererPlugin_H

#include "ACOsgRendererPlugin.h"

class ACSensorOsgRendererPlugin : public ACOsgRendererPlugin
{
public:
    ACSensorOsgRendererPlugin();
    ~ACSensorOsgRendererPlugin();
