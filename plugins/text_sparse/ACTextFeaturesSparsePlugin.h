 ...
 *
 */
#ifndef _ACTEXTFEATURESSPARSEPLUGIN_H
#define	_ACTEXTFEATURESSPARSEPLUGIN_H
...
class ACTextFeaturesSparsePlugin : public ACFeaturesPlugin, public ACPreProcessPlugin {
public:
	ACTextFeaturesSparsePlugin();
	~ACTextFeaturesSparsePlugin();
...
private:
	...
	vector<ACMediaFeatures*> tfCalculate(ACText* pMedia);
