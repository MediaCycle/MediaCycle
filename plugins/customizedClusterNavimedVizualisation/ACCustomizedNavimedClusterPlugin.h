...
#ifndef _ACCustomizedNavimedClusterPlugin_H
#define	_ACCustomizedNavimedClusterPlugin_H
...
class ACCustomizedNavimedClusterPlugin : public ACClusterMethodPlugin {
public:
	ACCustomizedNavimedClusterPlugin();
	~ACCustomizedNavimedClusterPlugin();
...
#endif	/* _ACCustomizedNavimedClusterPlugin_H */
