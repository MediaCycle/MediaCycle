/*
 *  ACLaughterTranscriptionPlugin.h
 *  MediaCycle
 *
...
#ifndef _ACLAUGHTERTRANSCRIPTIONPLUGIN_H
#define	_ACLAUGHTERTRANSCRIPTIONPLUGIN_H
...
class ACLaughterTranscriptionPlugin : public ACFeaturesPlugin {
public:
    ACLaughterTranscriptionPlugin();
    ~ACLaughterTranscriptionPlugin();
...
#endif	/* _ACLAUGHTERTRANSCRIPTIONPLUGIN_H */
