...
#ifndef _ACPosPlugDivvyPCATSNE_
#define _ACPosPlugDivvyPCATSNE_

class ACPosPlugDivvyPCATSNE : public ACClusterPositionsPlugin {
public:
    ACPosPlugDivvyPCATSNE();
    ~ACPosPlugDivvyPCATSNE();
