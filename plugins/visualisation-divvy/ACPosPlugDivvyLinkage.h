...
#ifndef _ACPosPlugDivvyLinkage_
#define _ACPosPlugDivvyLinkage_

class ACPosPlugDivvyLinkage : public ACClusterPositionsPlugin {
public:
    ACPosPlugDivvyLinkage();
    ~ACPosPlugDivvyLinkage();
