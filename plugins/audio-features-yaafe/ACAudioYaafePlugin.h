...
class ACAudioYaafePlugin : public ACAudioYaafeCorePlugin {

public:
    ACAudioYaafePlugin();
    virtual ~ACAudioYaafePlugin(){}
    virtual std::string dataflowFilename(){return "ACAudioYaafePluginSettings.txt";}
};
