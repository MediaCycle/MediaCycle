...
#ifndef _ACLibraryJsonWriterPlugin_H
#define	_ACLibraryJsonWriterPlugin_H

#include <MediaCycle.h>
#include <iostream>
#include <sstream>

class ACLibraryJsonWriterPlugin : public ACMediaLibraryWriterPlugin {
public:
    ACLibraryJsonWriterPlugin();
    ~ACLibraryJsonWriterPlugin();
...
#endif	/* _ACLibraryJsonWriterPlugin_H */
