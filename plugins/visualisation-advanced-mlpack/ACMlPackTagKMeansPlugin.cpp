...
#include <float.h>
#include <armadillo>
#include "ACMlPackTagKMeansPlugin.h"
...
ACMlPackTagKMeansPlugin::ACMlPackTagKMeansPlugin()
: ACMlPackKMeansPlugin() {
    this->mName = "MediaCycle MlPack KMeans & Tag";
    this->mDescription = "Plugin for KMeans Clustering by using MLPACK with tag media information exploitation";
}
...
void ACMlPackTagKMeansPlugin::updateClusters(ACMediaBrowser* mediaBrowser,bool needsCluster){
    ACMlPackKMeansPlugin::updateClusters(mediaBrowser,needsCluster);
