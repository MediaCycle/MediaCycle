...
#include "ACTagKnnRestrictedKMeansPlugin.h"
...
void ACTagKnnRestrictedKMeansPlugin::updateClusters(ACMediaBrowser* mediaBrowser,bool needsCluster){
    ACKnnRestrictedKMeansPlugin::updateClusters(mediaBrowser,needsCluster);
