...
#ifndef ACVideoFFmpegReaderPlugin_H
#define	ACVideoFFmpegReaderPlugin_H

class ACVideoFFmpegReaderPlugin : public ACMediaReaderPlugin
{
public:
    ACVideoFFmpegReaderPlugin();
    virtual ~ACVideoFFmpegReaderPlugin();
