...
#ifndef _ACPosPlugLinearTimeNeRV_
#define _ACPosPlugLinearTimeNeRV_

class ACPosPlugLinearTimeNeRV : public ACClusterPositionsPlugin {
public:
    ACPosPlugLinearTimeNeRV();
    ~ACPosPlugLinearTimeNeRV();
...
#endif // _ACPosPlugLinearTimeNeRV_
