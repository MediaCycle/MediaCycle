...
#ifndef ACAudioSvgFeaturesThumbnailerPlugin_H
#define	ACAudioSvgFeaturesThumbnailerPlugin_H
...
class ACAudioSvgFeaturesThumbnailerPlugin : public ACThumbnailerPlugin
{
public:
    ACAudioSvgFeaturesThumbnailerPlugin();
    virtual ~ACAudioSvgFeaturesThumbnailerPlugin();
