...
// e.g., choose audio/text/video, configure plugins, ...

// constructor : 
// parent is typically ACTextCycleOsgQt->parent
...
void SettingsDialog::setMediaCycleMainWindow(ACTextCycleOsgQt* _mc) {
	//XS test
	test=_mc;
