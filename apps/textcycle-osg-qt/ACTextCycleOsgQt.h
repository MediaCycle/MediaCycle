...
#ifndef HEADER_ACTEXTCYCLEOSGQT
#define HEADER_ACTEXTCYCLEOSGQT
...
class ACTextCycleOsgQt : public QMainWindow
	{
		Q_OBJECT
		
    public:
        ACTextCycleOsgQt(QWidget *parent = 0);
		~ACTextCycleOsgQt();
		void updateLibrary();
