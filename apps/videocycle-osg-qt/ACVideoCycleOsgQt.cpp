...
{
	ACVideoCycleOsgQt *window = (ACVideoCycleOsgQt*)userData;
	//printf("osc received tag: %s\n", tagName);
	//std::cout << "tagName: " << tagName << std::endl;
	window->processOscMessage(tagName);
}

ACVideoCycleOsgQt::ACVideoCycleOsgQt(QWidget *parent)
: QMainWindow(parent), library_loaded(false)
{
	...
	// XS TODO fichier de configuration
		...
		media_cycle->addPluginLibrary("../../../plugins/video/" + build_type + "/mc_video.dylib");	
...
ACVideoCycleOsgQt::~ACVideoCycleOsgQt()
{
...
void ACVideoCycleOsgQt::updateLibrary()
{
	if (!library_loaded) {
...
void ACVideoCycleOsgQt::on_pushButtonLaunch_clicked()
{
	this->loadACLFile();
	//ui.compositeOsgView->setFocus();
}

void ACVideoCycleOsgQt::on_pushButtonClean_clicked()
{
...
void ACVideoCycleOsgQt::loadACLFile(){
	QString fileName;
...
void ACVideoCycleOsgQt::saveACLFile(){
...
void ACVideoCycleOsgQt::loadMediaDirectory(){
...
void ACVideoCycleOsgQt::loadMediaFiles(){
	QString fileName;
...
void ACVideoCycleOsgQt::configureCheckBoxes(){
...
void ACVideoCycleOsgQt::cleanCheckBoxes(){
}

// NEW SLOTS
void ACVideoCycleOsgQt::modifyListItem(QListWidgetItem *item)
{
	// XS check
...
void ACVideoCycleOsgQt::synchronizeFeaturesWeights(){
...
void ACVideoCycleOsgQt::on_pushButtonRecenter_clicked()
{
	media_cycle->setCameraRecenter();
	//ui.compositeOsgView->setFocus();
}

void ACVideoCycleOsgQt::on_pushButtonBack_clicked()
{
	media_cycle->goBack();
	//ui.compositeOsgView->setFocus();
}

void ACVideoCycleOsgQt::on_pushButtonForward_clicked()
{
	media_cycle->goForward();
	//ui.compositeOsgView->setFocus();
}

void ACVideoCycleOsgQt::on_radioButtonClusters_toggled()
{
...
void ACVideoCycleOsgQt::on_sliderClusters_sliderReleased()
{
...
void ACVideoCycleOsgQt::on_comboBoxClustersMethod_activated(const QString & text) 
{
	std::cout << "Clusters Method: " << text.toStdString() << std::endl;
	media_cycle->changeClustersMethodPlugin(text.toStdString());
}

void ACVideoCycleOsgQt::on_comboBoxClustersPositions_activated(const QString & text) 
{
...
void ACVideoCycleOsgQt::on_comboBoxNeighborsMethod_activated(const QString & text) 
{
...
void ACVideoCycleOsgQt::on_comboBoxNeighborsPositions_activated(const QString & text) 
{
	std::cout << "Neighbors Method: " << text.toStdString() << std::endl;
	media_cycle->changeNeighborsPositionsPlugin(text.toStdString());	
}

void ACVideoCycleOsgQt::on_pushButtonMuteAll_clicked()
{
	media_cycle->muteAllSources();
	//ui.compositeOsgView->setFocus();
}

void ACVideoCycleOsgQt::on_comboBoxVideoSummary_activated(const QString & text)
{
	std::cout << "Video Summary: " << text.toStdString() << std::endl;
	int tracks = ui.compositeOsgView->getTimelineRenderer()->getNumberOfTracks();
	if (tracks>0){
...
void ACVideoCycleOsgQt::on_pushButtonFeedbackStart_clicked()
{
...
void ACVideoCycleOsgQt::processOscMessage(const char* tagName)
{	
