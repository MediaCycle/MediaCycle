...
class DatabaseMySql {
  ...
  /* public: constructor */
  function DatabaseMysql($query = "") {
	  global $gDBhost, $gDBname, $gDBuser, $gDBpass;
	  
  	  $this->Host     = $gDBhost;
      $this->Database = $gDBname;
      $this->User     = $gDBuser;
      $this->Password = $gDBpass ;
      $this->query($query);
  }
  ...
  function cleanInputString($input) {
	...
	return mysql_real_escape_string($input,$this->Link_ID);//no sql injection
  }
