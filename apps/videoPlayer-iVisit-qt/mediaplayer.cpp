...
m_videoWidget(new MediaVideoWidget(this, parent)), // XS 060910 added parent
...
//    sliderLayout->addWidget(timeLabel);    
    ...
    buttonPanelWidget->setSizePolicy(QSizePolicy::Expanding, QSizePolicy::Expanding); 
...
void MediaPlayer::openFile()
{
	...
	// XS changed default directory
	QString ddir = QString("/Users/xavier/numediart/Project10.1-Borderlands/2010_4rgb_alpha");
    QStringList fileNames = QFileDialog::getOpenFileNames(this, QString(), ddir);
...
void MediaPlayer::updateTime()
{
    ...
    QString timeString; 
	int sec, min, hour, msec, nframe;
    if (pos || len)
#ifdef USE_FPS
	sec = pos/1000;
	// XS todo: this is not general fps is assumed to be 25 -- read it somewhere!
	nframe = pos/40;
	timeString = QString::number(nframe);
#else
	{
        sec = pos/1000;
		min = sec/60;
...
// XS added
void MediaPlayer::seekTime(int t){
