...
////
@interface ACImageCycleOsgCocoa ()
...
- (void)initCommonACImageCycleOsgCocoa
{	 
}
...
- init
{
	if(self = [super init])
	{
		[self initCommonACImageCycleOsgCocoa];
	}
