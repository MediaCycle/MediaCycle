...
IF(APPLE)#to generalize for other platforms
	...
	INSTALL(PROGRAMS "${CMAKE_BINARY_DIR}/plugins/pcapreprocess/mc_pcapreprocess.dylib" DESTINATION ${PROGNAME}.app/Contents/MacOS COMPONENT Runtime)
	...
	ENDIF()
	IF(SUPPORT_NAVIMED AND USE_NAVIMED)
		INSTALL(PROGRAMS "${CMAKE_BINARY_DIR}/plugins/navimed/mc_navimed.dylib" DESTINATION ${PROGNAME}.app/Contents/MacOS COMPONENT Runtime)
