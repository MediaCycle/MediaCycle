...
IF(WITH_MC AND APPLE)#to generalize for other platforms
	...
	IF(SUPPORT_TEXT AND USE_TEXT)
		...
		INSTALL(PROGRAMS "${CMAKE_BINARY_DIR}/plugins/text_sparse/mc_text_sparse.dylib" DESTINATION ${PROGNAME}.app/Contents/MacOS COMPONENT ${PROGNAME})
		SET(MCPLUGINS "${MCPLUGINS}" "${CMAKE_INSTALL_PREFIX}/${PROGNAME}.app/Contents/MacOS/mc_text_sparse.dylib")
		INSTALL(PROGRAMS "${CMAKE_BINARY_DIR}/plugins/SparseVisualisation/mc_SparseVisualisation.dylib" DESTINATION ${PROGNAME}.app/Contents/MacOS COMPONENT ${PROGNAME})
