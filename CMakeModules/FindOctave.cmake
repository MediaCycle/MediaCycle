...
find_program(MKOCTFILE_EXECUTABLE NAME mkoctfile PATHS /Applications/Octave.app/Contents/Resources/bin)
...
if(MKOCTFILE_EXECUTABLE)
  ...
  execute_process(
    ...
    OUTPUT_VARIABLE _mkoctfile_all_ldflags
    RESULT_VARIABLE _mkoctfile_failed)
  string(REGEX REPLACE "[\r\n]" " " _mkoctfile_all_ldflags "${_mkoctfile_all_ldflags}")
  execute_process(
...
string(REGEX REPLACE " -L" ";" _mkoctfile_ldirs "${_mkoctfile_lflags}")
string(REGEX REPLACE "-L" "" _mkoctfile_ldirs "${_mkoctfile_ldirs}")

  string(REGEX REPLACE "(^| )-l([./+-_\\a-zA-Z]*)" " " _mkoctfile_ldflags "${_mkoctfile_all_ldflags}")
  string(REGEX REPLACE "(^| )-L([./+-_\\a-zA-Z]*)" " " _mkoctfile_ldflags "${_mkoctfile_all_ldflags}")
