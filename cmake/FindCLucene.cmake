...
IF(CLUCENE_FOUND)
	IF(CLUCENE_LIBRARY_SHARED)
		IF(EXISTS ${CLUCENE_INCLUDE_DIR}/CLucene/clucene-config.h)
			file(READ "${CLUCENE_INCLUDE_DIR}/CLucene/clucene-config.h" CLUCENE_CONFIG_FILE)
			string(REGEX MATCH ".*#define _CL_HAVE_PTHREAD[ \t]+1.*" CLUCENE_HAVE_PTHREAD "${CLUCENE_CONFIG_FILE}")
			IF(CLUCENE_HAVE_PTHREAD)
				MESSAGE("Using pthread")
				SET(THREAD_LIBRARY "-lpthread")
			ENDIF()
			LIST(APPEND THREAD_LIBRARY "-lz")
  			SET(CLUCENE_LIBRARIES ${CLUCENE_LIBRARY} ${CLUCENE_LIBRARY_SHARED} ${THREAD_LIBRARY})
		ELSE()
...
IF(EXISTS ${CLUCENE_INCLUDE_DIR}/CLucene/CLuceneConfig.cmake)
	...
	ENDIF()
ELSE()
	MESSAGE("Couldn't find CLucene version through CMake. PLease, verify your version is newer than 2.0 at least.")
ENDIF()
