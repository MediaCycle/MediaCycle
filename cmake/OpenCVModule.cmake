...
macro(_ocv_create_module)
  ...
  #CF  "${OPENCV_CONFIG_FILE_INCLUDE_DIR}/cvconfig.h" "${OPENCV_CONFIG_FILE_INCLUDE_DIR}/opencv2/opencv_modules.hpp"
  ...
  #CF add_dependencies(opencv_modules ${the_module})

  if(ENABLE_SOLUTION_FOLDERS)
    set_target_properties(${the_module} PROPERTIES FOLDER "modules")
  endif()

  #CF set_target_properties(${the_module} PROPERTIES
  ...
  #CF ocv_install_target(${the_module} EXPORT OpenCVModules OPTIONAL
